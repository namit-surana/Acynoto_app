...
class CustomCountryCodePickerState extends State<CustomCountryCodePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null) {
      internalWidget = InkWell(
        onTap: showCustomCountryCodePickerDialog,
        child: widget.builder!(selectedItem),
      );
    } else {
      internalWidget = GestureDetector(
        onTap: () {
          showCustomCountryCodePickerDialog();
        },
        child: TextButton(
          onPressed: widget.enabled ? showCustomCountryCodePickerDialog : null,
          child: Padding(
                  ...
                  Flexible(
                    ...
                    child: Padding(
                      ...
                      child: CustomImageView(
                        svgPath: ImageConstant.downArrow,
                        color: appTheme.black900,
                        width: 12.h,
                        height: 12.v,
                      ),
  ...
  void showCustomCountryCodePickerDialog() async {
